...
def main(emp = ''):
    ...
    stats = [[sg.Text('Finance', font=main_font_normal)],
        ...
        sg.Combo(default_value = year[0],values = year,k = 'year1',readonly = True,disabled = True, font=main_font_normal),
        sg.Combo(default_value = year[-1],values = year,k = 'year2',readonly = True,disabled = True, font=main_font_normal),
        ...
        sg.Combo(default_value = year[-1],values = year,k = 'year1_b',readonly = True,disabled = True, font=main_font_normal),
        sg.Combo(default_value = year[-1],values = year,k = 'year2_b',readonly = True,disabled = True, font=main_font_normal),
        sg.Button('Go',key = 'Go_b',disabled=True, font=main_font_normal)],
        [sg.Col([[sg.Combo(values = brand,readonly = True,visible = False,key='b1', font=main_font_normal)]]),
        sg.Col([[sg.Combo(values = brand,readonly = True,visible = False,key='b2', font=main_font_normal)]]),
        sg.Col([[sg.Combo(values = brand,readonly = True,visible = False,key='b3', font=main_font_normal)]])]]
